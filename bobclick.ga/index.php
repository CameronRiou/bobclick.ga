    ...
    <body>
        ...
        <table class="homebar">
            <tr>
                ...
                <th id="middle" class="SignInTitle">
                    Bobert Clicker
                </th>
                <th id="logIn">
                    <button id="logInBut">
		...
		<div id="SignUpModal" class="ModalMenu">
            <form class="ModalContent Animate" action="/" autocomplete="off" method="post">
                <div class="UpClose Animate">
                    <span> 
                        &times;
                    </span>
                </div>
                <h2 class="SignInTitle">
                    Sign Up
                </h2>
                <div id="SignInContent">
                    ...
                    <button type="submit" name="register" id="register" value="badger">
                        Sign Up
                    </button>
                </div>
            </form>
        ...
        <div id="SignInModal" class="ModalMenu">
            <form class="ModalContent Animate" action="/" autocomplete="off" method="post">
                ...
                <div id="SignInContent">
                    <input type="text" placeholder="Username" name="uname" required>
                    <input type="password" placeholder="Password" name="psw" required>
                    <button type="submit" name="login" id="login" value="ferret">
                        Login
                    </button>
                </div>
            </form>
